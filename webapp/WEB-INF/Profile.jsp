...
<body>
	<center>
		<div id="mainProfile">
			...
			<div id="hiderMenu">
				<a id="anchor" href="Home"><font color="white">Home</font>
				</a> <a id="anchor" href="Profile"><font color="indigo">My
						Profile</font>
				</a> <a id="anchor" href="Message"><font color="white">Message</font>
				</a> <a id="anchor" href="#" onclick="DisplayINeedBlockPro()"><font
					color="white">Looking for</font>
				</a> <a id="anchor" href="#" onclick="DisplayNotificationBlockPro()"><font
					color="white">Notification</font>
				</a> <a id="anchor" href="#" onclick="DisplayRequestBlockPro()"><font
					color="white">Requests</font>
				</a> <a id="anchor" href="#" onclick="return DisplaySettingBlock()"><font
					color="white">Setting</font>
				</a> <a id="anchor" href="index"><font color="white">LogOut</font>
				</a>
			</div>
			...
			<div style="height: 300px; width: 1400px;">
				...
				<div id="ProfileProducts">
					...
					<c:if  test="${!empty ProductList}">
					   <c:forEach items="${ProductList}" var="productNAME">
					  	  <img src="${pageContext.request.contextPath}/resources/images/product1.png" style="float: left; width: 70px; height: 60px;">
				...
				<div id="Friends">
					<h3>Friend's</h3>
					<img src="${pageContext.request.contextPath}/resources/images/friends1.png" style="float: left; width: 70px; height: 60px;">
				</div>
			</div>
		<div>
		<div id="OutsideProfileDetails">
			<div  id="ProfileDetails">
			<img id="EditProfileDetails" src="${pageContext.request.contextPath}/resources/images/edit1.png" >
				...
				<c:if test="${!empty educationworkList}">
					<table>
						<c:forEach items="${educationworkList}" var="educationWORK">
							<tr>
								<td style="width: 200px;"><b>Name of School :</b>
								</td>
								<td>${educationWORK.school}</td>
							</tr>
							<tr>
								<td><b>Name of College  :</b>
								</td>
								<td>${educationWORK.collage}</td>
							</tr>
							<tr>
								<td><b>Graduation Degree :</b>
								</td>
		...
		<div id="OutsideProfileDetails">
			...
			<input id="EditProfileDetails" type="submit" value="" style="background-image: url('${pageContext.request.contextPath}/resources/images/edit1.png');">
				...
				<c:if test="${!empty familyList}">
					<table>
						<c:forEach items="${familyList}" var="family">
							...
							<tr>
								<td><b>Family Status :</b>
								</td>
								<td>${family.familyStatus}</td>
							</tr>
							<tr>
								<td><b>Family Income :</b>
								</td>
				...
				<c:if test="${!empty hobbiesList}">
					<table>
						<c:forEach items="${hobbiesList}" var="hobbiesDetails">
							<tr>
								<td style="width: 200px;"><b>Hobbies :</b>
								</td>
								<td>${hobbiesDetails.hobbies}</td>
							</tr>
							<tr>
								<td><b>Favourite Music :</b>
								</td>
								<td>${hobbiesDetails.favouriteMusic}</td>
							</tr>
							<tr>
								<td><b>Favourite Book :</b>
								</td>
			...
			<input id="EditProfileDetails" type="submit" value="" name="editOtherReqBtn" style="background-image: url('${pageContext.request.contextPath}/resources/images/edit1.png');">
			...
			<div id="InsideProfileDetails">	
					...
					<table>
						<c:forEach items="${otherDetailsList}" var="otherDetails">
							...
							<tr>
								<td><b>Polytical Status :</b>
								</td>
								<td>${otherDetails.polyticalstatus}</td>
							</tr>
							<tr>
								<td><b>Social Activities :</b>
								</td>
			...
			<div id="InsideProfileDetails">	
					<table>
						<c:forEach items="${EditOtherDetailsList}" var="EditOtherDetails">
							<tr>
								<td style="width:200px"><b>Social Status :</b></td>
								<td style="width:590px;"><input type="text" placeholder="${EditOtherDetails.socialStatus}"></td>
							</tr>
							<tr>
								<td><b>Polytical Status :</b>
								</td>
								<td><input type="text" placeholder="${EditOtherDetails.polyticalstatus}"></td>
							</tr>
							<tr>
								<td><b>Social Activities :</b>
								</td>
								<td><input type="text" placeholder="${EditOtherDetails.socialact}"></td>
							</tr>
							<tr>
								<td><b>Polytical Activities :</b></td>
								<td><input type="text" placeholder="${EditOtherDetails.polyticalact}"></td>
							</tr>
							<tr>
								<td><b>Cultural activities :</b>
								</td>
