...
<body>
	<center>
		<div id="main">
			...
			<div id="rightMain"
				style="margin-top: -1003px; float: right; margin-right: 4px;">
											...
											<tr>
												<form action="/vanjariudyogvishwa-v2/FriendProfile"
													...
													<td><img
														...
														height="30" width="30"></td>
													<td><input type="submit"
														value="${knownPeople[1]} ${knownPeople[2]}"
														style="background: none; border: none;"><br>
														<font size="2" color="gray"> </font></td>
												...
												<td>
													<form action="/vanjariudyogvishwa-v2/sendFriendRequest"
														...
														<input type="hidden" name="JspPageName" value="Friendlist">
														<input type="hidden" name="requestTo"
															value="${knownPeople[0]}"> <input type="hidden"
															name="requestFrom" value="${loginUser.email}"> <input
															type="submit" value="Connect" class="connectBtn"
															style="float: right;">
													</form>
												</td>
											</tr>
			...
			<table>
				<tr>
					<td height="45" width="1400" colspan="2" bgcolor="#fab039"
						align="center"><span class="style10"> About |
							Developers | Create Ad | Music | Games | Apps | Privacy | Help</span>
