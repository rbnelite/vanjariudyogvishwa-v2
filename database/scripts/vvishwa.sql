...
CREATE TABLE EMPLOYMENT (
  ...
  FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL),
  CONSTRAINT "employement_uniqueKey" UNIQUE (email)
);
...
/*TABLE STRUCTURE FOR TABLE INTREST_AREAS */
...
CREATE TABLE INTREST_AREAS (
  ...
  FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL),
  CONSTRAINT "interest_areas_uniqueKey" UNIQUE (email)
);
...
CREATE TABLE HOBBIES (
  ...
  FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL),
  CONSTRAINT "hobbies_uniqueKey" UNIQUE (email)
);
...
CREATE TABLE OTHER_DETAILS (
  ...
  FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL),
  CONSTRAINT "other_details_uniqueKey" UNIQUE (email)
);
...
CREATE TABLE PROFILE_IMAGES (
  ...
  FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL),
  CONSTRAINT "profile_image_uniqueKey" UNIQUE (email)
);
