...
@Repository
public class ChangePasswordDaoImpl extends BaseDao<ChangePassword>implements ChangePasswordDao {
	...
	public void changePassword(ChangePassword changepassword) {
		...
		Query query=session.createQuery("update ChangePassword set Password=:newpassword where Password=:oldpass and user_email=:uemail");
