...
@Repository
public class ProfileImageDaoImpl extends BaseDao<ProfileImages> implements ProfileImageDao {
	...
	public List<ProfileImages> getProfileImage(String UserMail) {
		...
		return sessionFactory.getCurrentSession().createQuery("From ProfileImages where userMail='"+UserMail+"' ").list();
	}
	...
	public void UpdateProfileImage(String fileName,  String userName) {
		...
		Query query=session.createQuery("Update ProfileImages set profileImage=:fileName where userMail=:userName");
