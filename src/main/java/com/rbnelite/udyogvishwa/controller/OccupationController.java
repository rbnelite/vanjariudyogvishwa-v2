...
public String editOccupation(@ModelAttribute Occupation occupation, Map<String, Object> map) throws ServletException {
	
	LoginUser loginUser = RequestContext.getUser();
	String emailId=loginUser.getEmail();
	System.out.println("from Occupation Controller- editOccupation("+emailId+") method");
		
		ocservice.updateOccupation(occupation);
